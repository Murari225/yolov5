...
function uploadFile(file) {
    // Validate file
    const allowedTypes = ['image/jpeg', 'image/png', 'image/gif', 'image/bmp', 'video/mp4', 'video/avi', 'video/quicktime', 'video/x-matroska'];
...
function displayResults(response) {
    ...
    if (Object.keys(data.object_counts).length > 0) {
        ...
        const sortedObjects = Object.entries(data.object_counts).sort((a, b) => b[1] - a[1]);
